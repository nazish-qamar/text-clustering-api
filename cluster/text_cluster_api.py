...
def cluster():
    ...
    #table for telling deciding keywords with their weights for each cluster
    clusters = []
    ...
    #Pivot table- displays stats about data
    ...
    chart.add_series({
            'values': '=Cluster_Report!$B$2:$B'+str(no_of_clusters+1) #this is the excel formula
            })
